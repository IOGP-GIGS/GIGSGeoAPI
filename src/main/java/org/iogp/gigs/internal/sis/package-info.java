...
/**
 * Helper classes for execution of GIGS tests.
 * This package contains accessor to API specific to the Apache SIS project.
 * It is used as a workaround for methods that are missing in GeoAPI 3.0.x.
 *
